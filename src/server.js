...
const territoryZonesRoutes = require('./routes/territoryZones');
...
// Map routes are publicly readable (no requireAuth) so territory polygons
// and the leaderboard load for all visitors, not just logged-in users.
app.use('/api/map', mapRoutes);
app.use('/api/zones', requireAuth, zonesRoutes);
app.use('/api/social', requireAuth, socialRoutes);
app.use('/api/territory-zones', territoryZonesRoutes);
